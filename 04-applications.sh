...
if yay -S --noconfirm --cleanafter firefox ghostty nodejs npm 1password spotify signal-desktop lazygit neovim obsidian libreoffice-fresh btop fzf ripgrep; then
    ...
    failed_packages=""
    for package in firefox ghostty nodejs npm 1password spotify signal-desktop lazygit neovim obsidian libreoffice-fresh btop fzf ripgrep; do
